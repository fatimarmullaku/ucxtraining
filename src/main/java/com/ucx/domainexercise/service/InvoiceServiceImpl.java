...
public class InvoiceServiceImpl implements InvoiceService {
    ...
    @Override
    public Invoice generateInvoice(List<LineItem> lineItemList, Costumer costumer) {
        if(lineItemList == null || lineItemList.isEmpty()){
            throw new RuntimeException("Cannot print Invoice, list is missing");
        }
        if(costumer == null){
            throw new RuntimeException("Cannot print Invoice, Costumer is missing");
        }
